...
const listings = [
  {
    id: 1,
    title: "Studio Apartment in Bagumbayan",
    type: "Apartment",
    city: "Bagumbayan",
  ...
  {
    id: 2,
    title: "Affordable Dormitory in Tagas",
    type: "Dormitory",
    city: "Tagas",
    address: "Brgy. Tagas, Daraga, Albay",
    price: 3500,
    people: "Good for 1 person (bunk bed)",
    gender: "Mixed",
    desc: "Budget-friendly dormitory for students in Tagas. Includes 3 meals a day. Safe and secure with 24-hour guard.",
  ...
  {
    id: 3,
    title: "Boarding House Room in Sagpon",
    type: "Boarding House",
    city: "Sagpon",
    address: "Brgy. Sagpon, Daraga, Albay",
    price: 4000,
    people: "Good for 1–2 persons",
    gender: "Female Only",
    desc: "Private room in a clean and secure boarding house in Sagpon. Near public transport and wet market. Exclusively for female tenants.",
  ...
  {
    id: 4,
    title: "Bedspace for Rent in Ilawod",
    type: "Bedspace",
    city: "Ilawod",
    address: "Brgy. Ilawod, Daraga, Albay",
    price: 2000,
    people: "Good for 1 person",
    gender: "Male Only",
    desc: "Clean and affordable bedspace in a shared room in Ilawod. Near market area and transport terminal. For male tenants only.",
  ...
  {
    id: 5,
    title: "Modern Apartment in Binitayan",
    type: "Apartment",
    city: "Binitayan",
    address: "Brgy. Binitayan, Daraga, Albay",
    price: 7500,
    people: "Good for 1–3 persons",
    gender: null,
    desc: "Newly built 1-bedroom apartment with modern interior in Binitayan. Fully furnished with air-conditioning and free Wi-Fi. Pet friendly.",
  ...
  {
    id: 6,
    title: "Female Student Dorm in Anislag",
    type: "Dormitory",
    city: "Anislag",
    address: "Brgy. Anislag, Daraga, Albay",
    price: 3200,
    people: "Good for 1 person",
    gender: "Female Only",
    desc: "Safe student dormitory in Anislag. Strict 10PM curfew. Near Bicol University and transport routes. Caters to female students only.",
  ...
  {
    id: 7,
    title: "Spacious Boarding House in Maroroy",
    type: "Boarding House",
    city: "Maroroy",
    address: "Brgy. Maroroy, Daraga, Albay",
    price: 5000,
    people: "Good for 2–3 persons",
    gender: "Mixed",
    desc: "Spacious shared room in a well-maintained boarding house in Maroroy. All utilities included in the monthly rate.",
  ...
  {
    id: 8,
    title: "Affordable Bedspace in Busay",
    type: "Bedspace",
    city: "Busay",
    ...
    people: "Good for 1 person",
    gender: "Mixed",
    desc: "Budget bedspace for students and workers in Busay. Shared room with lockers provided. Near public transport terminal.",
  ...
  {
    id: 9,
    title: "2-Bedroom Apartment in Bascaran",
    type: "Apartment",
    city: "Bascaran",
    address: "Brgy. Bascaran, Daraga, Albay",
    price: 8000,
    people: "Good for 2–4 persons",
    gender: null,
    desc: "Newly renovated 2-bedroom apartment in Bascaran ideal for small families or groups. Complete appliances and parking slot included.",
  ...
  {
    id: 10,
    title: "Female Dormitory in Kilicao",
    type: "Dormitory",
    city: "Kilicao",
    address: "Brgy. Kilicao, Daraga, Albay",
    price: 2800,
    people: "Good for 1 person (female only)",
    gender: "Female Only",
    desc: "Safe and well-maintained female dormitory in Kilicao. Meals optional. Peaceful environment close to schools and transport.",
...
function setCity(city) {
  ...
  applyFilters();
  scrollToId('listings');
  showToast(`Showing listings in Brgy. ${city}, Daraga`, 'fa-location-dot');
}
...
function createCard(l, animIndex) {
  ...
  card.innerHTML = `
    ...
    <div class="lc-body">
      <div class="lc-city"><i class="fa-solid fa-location-dot"></i> Brgy. ${l.city}, Daraga</div>
...
function openDetail(id) {
  ...
  if (cityEl) cityEl.innerHTML = `<i class="fa-solid fa-location-dot"></i> Brgy. ${l.city}, Daraga, Albay`;
  ...
  if (gEl) {
    ...
    if (l.gender && l.type !== 'Apartment') {
      ...
      if (d) { gEl.classList.add(d[0]); gEl.innerHTML = `<i class="fa-solid ${d[1]}"></i> ${d[2]}`; gEl.classList.remove('hidden'); }
  ...
  if (saveBtn) { saveBtn.classList.remove('saved'); saveBtn.innerHTML = '<i class="fa-regular fa-heart"></i> Save Listing'; }
...
function toggleDetailFav(btn) {
  ...
  btn.innerHTML = active ? `<i class="fa-solid fa-heart"></i> Saved` : `<i class="fa-regular fa-heart"></i> Save Listing`;
  showToast(active ? 'Saved to favourites!' : 'Removed from favourites.', active ? 'fa-heart' : 'fa-heart-crack');
}
...
function previewUpload(input, previewId) {
  ...
  if (file.type.startsWith('image/')) {
    ...
    reader.onload = ev => {
      ...
      img.src = ev.target.result; img.title = file.name;
...
function initBackToTop() {
  ...
  btn.className = 'back-to-top'; btn.setAttribute('aria-label', 'Back to top');
...
function initOverviewActivity() {
  ...
  if (!panel) return;
  const feed = [
    { icon: 'fa-user',               type: 'green',  text: '<strong>Maria Santos</strong> inquired about Studio Apt. in Bagumbayan',   time: '2h ago' },
    { icon: 'fa-calendar-check',     type: 'blue',   text: 'Visit confirmed with <strong>Pedro Villanueva</strong> on Dec 23',         time: '5h ago' },
    { icon: 'fa-house-circle-check', type: 'orange', text: 'Your listing <strong>"Boarding House Sagpon"</strong> is under review',    time: '1d ago' },
    { icon: 'fa-circle-check',       type: 'green',  text: 'Listing <strong>"Dorm in Anislag"</strong> approved and live',             time: '2d ago' },
    { icon: 'fa-envelope',           type: 'amber',  text: '<strong>Ana Reyes</strong> sent a message about bedspace in Busay',        time: '3d ago' }
  ];
...
(function initScrollReveal() {
  ...
  const obs = new IntersectionObserver(entries => {
    entries.forEach(entry => {
      ...
      setTimeout(() => { entry.target.style.opacity = '1'; entry.target.style.transform = 'translateY(0)'; }, Math.min(idx * 60, 360));
